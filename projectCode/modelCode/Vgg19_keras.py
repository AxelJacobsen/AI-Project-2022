...
from ..dataNormalizaiton.dataHandler import handleTrainingData
...
#TROR IKKE VI TRENGER DETTE, MEN VET IKKE HELT
...
# data loading
(x_train, y_train), (x_test, y_test) = cifar10.load_data()  ## LOAD IN FROM DATAHANDLER FILE
